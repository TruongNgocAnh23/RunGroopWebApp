...
namespace RunGroopWebApp.Migrations
{
    ...
    [Migration("20240228222527_AddTableVer2")]
    partial class AddTableVer2
    {
            ...
            modelBuilder.Entity("RunGroopWebApp.Models.ArtilesImage", b =>
                {
                    ...
                    b.HasIndex("ArtilesId")
                        .IsUnique()
                        .HasFilter("[ArtilesId] IS NOT NULL");
            ...
            modelBuilder.Entity("RunGroopWebApp.Models.ArtilesImage", b =>
                {
                    b.HasOne("RunGroopWebApp.Models.Artiles", "Artiles")
                        .WithOne("ArtilesImage")
                        .HasForeignKey("RunGroopWebApp.Models.ArtilesImage", "ArtilesId");
